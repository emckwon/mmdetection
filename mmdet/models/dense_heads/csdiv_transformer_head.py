...
class CSDivTransformerHead(AnchorFreeHead):
    ...
    def loss_single(self,
        ...
        loss_cs = self.loss_cs(bbox_preds, cls_scores, gt_bboxes_list, gt_labels_list, avg_factor=num_imgs)
    ...
    def get_targets(self,
        ...
        (bbox_targets_list, pos_inds_list, neg_inds_list) = multi_apply(
             self._get_target_single, cls_scores_list, bbox_preds_list,
             gt_bboxes_list, gt_labels_list, img_metas, gt_bboxes_ignore_list)
        num_total_pos = sum((inds.numel() for inds in pos_inds_list))
        num_total_neg = sum((inds.numel() for inds in neg_inds_list))
        return (bbox_targets_list, num_total_pos, num_total_neg)
    ...
    def _get_target_single(self,
        ...
        return (bbox_targets, pos_inds, neg_inds)
